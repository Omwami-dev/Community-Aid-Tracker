    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='aid.project')),
            ],
        ),
        migrations.CreateModel(
            name='User',
        ...
        migrations.AddField(
            model_name='project',
            name='created_by',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='aid.user'),
        ),
        migrations.CreateModel(
            name='Donation',
            fields=[
                ...
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='aid.project')),
                ('donor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='aid.user')),
            ],
        ),
        migrations.CreateModel(
            name='Volunteer',
